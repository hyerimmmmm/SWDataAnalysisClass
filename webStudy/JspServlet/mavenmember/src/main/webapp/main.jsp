...
<body>
	...
	<div id="wrapper">
		...
		<!-- 로그인 된 상태에서 클릭할 수 있는 '로그아웃'과 개인정보수정으로 갈 수 있는 a태그 -->
		<% if(member == null) { %>
			<a href="#menu">로그인</a>		
		<% } else { %>
			<a href="#">로그아웃</a>
		...
		<ul class="actions vertical">
			<li><h5>회원가입</h5></li>
			<form action="join.do">
				<li><input type="text" placeholder="Email을 입력하세요" name="id"
					id="inputId"></li>
				<li><span id="idCheckMsg">아이디 중복 확인 메시지</span></li>
				<li><input type="password" placeholder="PW를 입력하세요" name="pw"></li>
		...
		<div class="inner">
			...
			<div class="contact-method">
				...
				<% } else { %>
				<a href="#"><%= member.getId() %>@naver.com</a>
				<% } %>
